...
def main():
    ...
    raw_texts_dir = Path(f'{current_directory}/raw_textss')
    texts_dir = Path(f'{current_directory}/textss')
    ...
    for image in Path(f'{current_directory}/down').rglob('*.png'):
        images2.append(image)
    for image in Path(f'{current_directory}/down').rglob('*.jpg'):
        images2.append(image)
...
def ocr_image(image, line, credentials, current_directory):
    ...
    while True:
        try:
            ...
            raw_txtfile = f'{current_directory}/raw_textss/{imgname[:-5]}.txt'
            txtfile = f'{current_directory}/textss/{imgname[:-5]}.txt'
